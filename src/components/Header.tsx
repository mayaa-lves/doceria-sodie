          ...
          <ul className="flex items-center text-[#5C3D2E] font-medium text-sm lg:text-base">
            ...
            <li className="relative group px-4 border-r border-[#A89F95] last:border-r-0 text-[#5C3D2E] hover:text-[#3D251A] transition-colors cursor-pointer py-2">
                ...
                <div className="absolute left-0 top-full mt-1 w-48 bg-[#E2D8C9] rounded-b-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 overflow-hidden">
                    ...
                    <li>
                        <Link href="/produtos" className="block px-4 py-2 hover:bg-[#D6CBB9] transition-colors">Bolos</Link>
                    </li>
                    <li>
                        <Link href="/produtos" className="block px-4 py-2 hover:bg-[#D6CBB9] transition-colors">Chocolates</Link>
                    </li>
                    <li>
                        <Link href="/produtos" className="block px-4 py-2 hover:bg-[#D6CBB9] transition-colors">Salgados</Link>
                    </li>
                    <li>
                        <Link href="/produtos" className="block px-4 py-2 hover:bg-[#D6CBB9] transition-colors">Kit Festa</Link>
                    </li>
                    <li>
                        <Link href="/produtos" className="block px-4 py-2 hover:bg-[#D6CBB9] transition-colors">Doces</Link>
                    </li>
                    <li>
                        <Link href="/produtos" className="block px-4 py-2 hover:bg-[#D6CBB9] transition-colors">Tortas Doces</Link>
                    </li>
                    <li>
                        <Link href="/produtos" className="block px-4 py-2 hover:bg-[#D6CBB9] transition-colors">Bebidas</Link>
                    </li>
                    <li>
                        <Link href="/produtos" className="block px-4 py-2 hover:bg-[#D6CBB9] transition-colors">Balas de Coco</Link>
                    </li>
                    </ul>
                </div>
